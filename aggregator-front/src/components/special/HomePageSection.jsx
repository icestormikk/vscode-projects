...
export default class HomePageSection extends Component {
    ...
    render() {
        return (
            <div className={'w-full relative flex justify-center ' + this.props.heightCoefficient}>
                <img src={this.props.backgroundPicture} alt="" className='absolute top-0 left-0 z-[-1] h-full w-full object-none brightness-50' />
                <div className={'w-5/6 my-2 flex ' + (this.props.textside === 'right' ? 'justify-end' : 'justify-start')}>
